    ...
    return (
        ...
        >
            ...
            <div style={{
                position: 'absolute',
                inset: 0,
                background: 'radial-gradient(ellipse 120% 100% at 30% 20%, rgba(255, 153, 0, 0.04) 0%, transparent 50%)',
                pointerEvents: 'none',
            }} />
            ...
            <div className="projects-grid" style={{
                ...
                <aside className="projects-sidebar" style={{
                    ...
                    {/* Section Title */}
                    <div style={{ marginBottom: '35px', paddingTop: '25px' }}>
                        <div style={{
                            display: 'flex',
                            alignItems: 'center',
                            gap: '12px',
    ...
    return (
        <button
            ...
            style={{
                ...
                border: `1px solid ${primary ? 'var(--tva-amber)' : 'rgba(255, 153, 0, 0.3)'}`,
                color: primary
                ...
                transition: 'all 0.3s ease',
                overflow: 'hidden',
                boxShadow: primary && isHovered ? '0 0 30px rgba(255, 153, 0, 0.4)' : 'none',
            }}
        >
            {children}
        </button>
