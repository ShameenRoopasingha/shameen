...
import { SKILLS, REFERENCES } from '@/lib/data';
...
export function DiagnosticSection() {
    ...
    return (
        ...
        >
            ...
            <div className="h-full overflow-y-auto flex items-start lg:items-center justify-center px-6 lg:px-16 pt-24 lg:pt-0 pb-16 lg:pb-0">
                <div className="w-full max-w-6xl flex flex-col lg:flex-row gap-8 lg:gap-12 mt-4 lg:mt-0">
